...
<span class="cute-font-regular">
	<div class="text-center text-black">
		<h1 class="display-6 fw-bolder"style="font-size: 45px">판매중인 상품</h1>
	</div>
 ...
 %> <!-- Product details-->
							...
							<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
								<div class="text-center">
									<a class="btn btn-outline-dark mt-auto" href="/updateboard.do?sale_no=<%=sbd.getSale_no()%>">수정</a> <a class="btn btn-outline-dark mt-auto" href="/deleteboard.do?sale_no=<%=sbd.getSale_no()%>">삭제</a>
								</div>
							</div>
						</a>
					</div>
