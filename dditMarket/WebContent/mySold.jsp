...
List<SailBoardVO> soldboardList = (List<SailBoardVO>) request.getAttribute("soldboardList");
...
<span class="cute-font-regular">
	<div class="text-center text-black">
		<h1 class="display-6 fw-bolder">판매 완료 상품</h1>
	</div>

	<%
		int soldboardSize = soldboardList.size();
	if (soldboardSize > 0) {
	%>
	<section class="py-5">
		<div class="container px-4 px-lg-5 mt-5">
			<div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
				<%
					for (SailBoardVO sbd : soldboardList) {
				%>
				<div class="col mb-5">
 ...
 %> <!-- Product details-->
							...
							<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
								<div class="text-center">
									<a class="btn btn-outline-dark mt-auto" href="/deleteboard.do?sale_no=<%=sbd.getSale_no()%>">삭제</a>
								</div>
							</div>
						</a>
					</div>
